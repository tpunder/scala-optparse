...
crossScalaVersions := Seq("2.8.1", "2.8.2", "2.9.0", "2.9.0-1", "2.9.1", "2.9.2", "2.10.0-M6", "2.10.0-RC1", "2.10.0-RC2", "2.10.0-RC3", "2.10.0-RC5")
...
libraryDependencies <<= (scalaVersion, libraryDependencies) { (sv, deps) =>
  val versionMap = Map("2.10.0-M6" -> "1.9-2.10.0-M6-B2", "2.10.0-RC3" -> "1.8-B1", "2.10.0-RC5" -> "1.8-B1")
